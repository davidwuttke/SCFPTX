...
\caption{Robustness checks. Models (1) and (2) feature random effects. Models (3) and (4) are performed on a subset matching a formerly published study (BLINDED FOR REVIEW).}
\label{tab:robust_2}
\end{table}%{htb} 
